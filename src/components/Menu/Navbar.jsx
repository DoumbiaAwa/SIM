                    ...
                    <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div className="d-flex m-3 me-0">
                            ...
                            <a href="#" className="position-relative me-4 my-auto">
                                ...
                                <span className="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style={{top: -5, left: 15, height: 20,minWidth: '20px'}}>3</span>
                            </a>
