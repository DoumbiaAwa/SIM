                    ...
                    <table className="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img  src={require('./img/vegetable-item-5.jpg')}  className="img-fluid me-5 rounded-circle" style= {{width: 80, height: 80}} alt=""/>
                                    </div>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img  src={require('./img/vegetable-item-2.jpg')} className="img-fluid me-5 rounded-circle" style= {{width: 80, height: 80,}} alt=""/>
                                    </div>
                                </th>
                                <td>
