                                ...
                                <div className="tab-content mb-5">
                                    ...
                                    <div className="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                        <div className="d-flex">
                                            <img  src={require('./img/avatar.jpg')} className="img-fluid rounded-circle p-3" style= {{width: 100, height: 100}} alt=""/>
                                            <div className="">
                        ...
                        <div className="row g-4 fruite">
                            ...
                            {/* <div className="col-lg-12">
                                ...
                                <div className="d-flex align-items-center justify-content-start">
                                    <div className="rounded" style= {{width: 100, height: 100}}>
                                        <img  src={require('./img/featur-1.jpg')} className="img-fluid rounded" alt="Image"/>
                                    </div>
                                    <div>
                                ...
                                <div className="d-flex align-items-center justify-content-start">
                                    <div className="rounded" style= {{width: 100, height: 100}} >
                                        <img  src={require('./img/featur-2.jpg')} className="img-fluid rounded" alt=""/>
                                    </div>
                                    <div>
                                        <h6 className="mb-2">Big Banana</h6>
                                        <div className="d-flex mb-2">
                                ...
                                <div className="d-flex align-items-center justify-content-start">
                                    <div className="rounded" style= {{width: 100, height: 100}}>
                                        <img src={require('./img/featur-1.jpg')} className="img-fluid rounded" alt=""/>
                                    </div>
                                    <div>
                                        <h6 className="mb-2">Big Banana</h6>
                                        <div className="d-flex mb-2">
                                ...
                                <div className="d-flex align-items-center justify-content-start">
                                    <div className="rounded me-4" style= {{width: 100, height: 100}}>
                                        <img  src={require('./img/vegetable-item-4.jpg')} className="img-fluid rounded" alt=""/>
                                    </div>
                                    <div>
                                        <h6 className="mb-2">Big Banana</h6>
                                        <div className="d-flex mb-2">
                                ...
                                <div className="d-flex align-items-center justify-content-start">
                                    <div className="rounded me-4" style= {{width: 100, height: 100}}>
                                        <img  src={require('./img/vegetable-item-5.jpg')} className="img-fluid rounded" alt=""/>
                                    </div>
                                    <div>
                                        <h6 className="mb-2">Big Banana</h6>
                                        <div className="d-flex mb-2">
                                ...
                                <div className="d-flex align-items-center justify-content-start">
                                    <div className="rounded me-4" style= {{width: 100, height: 100}}>
                                        <img  src={require('./img/vegetable-item-6.jpg')} className="img-fluid rounded" alt=""/>
                                    </div>
                                    <div>
                                        <h6 className="mb-2">Big Banana</h6>
                                        <div className="d-flex mb-2">
                            ...
                            {/* <div className="col-lg-12">
                                <div className="position-relative">
                                    <img   src={require('./img/banner-fruits.jpg')} className="img-fluid w-100 rounded" alt=""/>
                                    <div className="position-absolute" style= {{top: 50, right: 10, }}>
                                        <h3 className="text-secondary fw-bold">Fresh Fruits  Banner</h3>
                                    </div>
                                </div>
                            </div> */}
                        </div>
